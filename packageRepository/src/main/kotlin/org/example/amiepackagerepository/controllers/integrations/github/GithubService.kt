...
import org.example.amiepackagerepository.controllers.integrations.github.dto.GithubEndpointDto
import org.example.amiepackagerepository.controllers.integrations.github.dto.GithubItemDto
import org.example.amiepackagerepository.controllers.integrations.github.dto.GithubSearchableDto
    ...
    fun listFilesGithub(): List<GithubItemDto> {
        ...
        try {
            ...
            response = restClient.get()
                ...
                .toEntity(object : org.springframework.core.ParameterizedTypeReference<List<GithubContentResponseDto>>() {})
        ...
        fun walk(path: String) {
            ...
            try {
                val response = restClient.get()
                    ...
                    .retrieve()
                    .body(object : org.springframework.core.ParameterizedTypeReference<List<GithubContentResponseDto>>() {})
    ...
    fun uploadFile(username: String,
        ...
        try {
            ...
            fun MutableMap<String, String>.updateJson(existingContentBase64: String?, updateApply: (GithubSearchableDto.() -> Unit)?): String {
                ...
                val newEntry = GithubSearchableDto(url = url, lang = progLanguage)
